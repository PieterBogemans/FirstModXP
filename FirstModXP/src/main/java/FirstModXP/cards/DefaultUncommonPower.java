...
import FirstModXP.actions.UncommonPowerAction;
...
public class DefaultUncommonPower extends AbstractDynamicCard {
    ...
    public static final String ID = FirstModXp.makeID(DefaultUncommonPower.class.getSimpleName());
