...
import FirstModXP.patches.relics.BottledPlaceholderField;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = FirstModXp.makeID("BottledPlaceholderRelic");
